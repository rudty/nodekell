...
let randomUintInternal: (size: number) => number;
...
if (typeof exports === "object" &&
    ...
    randomUintInternal = (size: number) => {
...
const randomInternal = (begin: number, end: number) => {
 ...
 */
export const random: Random = (...k: any[]): number => {
    const len = k.length;
