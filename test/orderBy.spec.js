...
describe('test orderBy', () => {
    it('number array', async () => {
        ...
        const r0 = F.orderBy(e => e, F.asc, a);
        const r1 = F.orderBy(e => e, F.desc)(a);
    ...
    it('promise number array', async () => {
        ...
        const r0 = F.orderBy(async e => e, F.asc, a);
        const r1 = F.orderBy(async e => e)(F.desc, a);
    ...
    it('object array', async () => {
        ...
        const r0 = F.orderBy(e => e.releaseDate, F.asc, a);
        const r1 = F.orderBy(e => e.releaseDate)(F.desc)(a);
    ...
    it('promise object array', async () => {
        ...
        const r0 = F.orderBy(async e => e.releaseDate, F.asc, a);
        const r1 = F.orderBy(async e => e.releaseDate, F.desc, a);
    ...
    it('deep object array', async () => {
        ...
        const r0 = F.orderBy(e => e.a.b.c.d, F.asc, a);
        const r1 = F.orderBy(e => e.a.b.c.d, F.desc, a);
    ...
    it('map array', async () => {
        ...
        const r0 = F.orderBy(e => e.get('year'), F.asc, a);
        const r1 = F.orderBy(e => e.get('year'), F.desc, a);
    ...
    it('set order parameter to asc / desc string', async () => {
        ...
        const r0 = F.orderBy(e => e, 'asc', a);
        const r1 = F.orderBy(e => e, 'ASC', a);
        const r2 = F.orderBy(e => e, 'desc', a);
        const r3 = F.orderBy(e => e, 'DESC', a);
