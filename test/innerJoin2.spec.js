...
describe('test innerJoin2', () => {
    ...
    it('default iterator', async () => {
        const r0 =  await F.collect(
            F.innerJoin2(joinByCustomerId, orders[Symbol.iterator](), customers[Symbol.iterator]())
        );
        assert.deepStrictEqual(r0, [ 
      [ { orderId: 1, customerId: 1, desc: 't1' },
        { customerId: 1, name: 'ana' } ],
    ...
    it('compare left promise', async () => {
        const r0 =  await F.collect(
            F.innerJoin2(promiseJoinByCustomerId, promiseOrders, customers)
        );
        assert.deepStrictEqual(r0, [ 
      [ { orderId: 1, customerId: 1, desc: 't1' },
        { customerId: 1, name: 'ana' } ],
    ...
    it('compare right promise', async () => {
        const r0 =  await F.collect(
            F.innerJoin2(promiseJoinByCustomerId, orders, promiseCustomers)
        );
        assert.deepStrictEqual(r0, [ 
      [ { orderId: 1, customerId: 1, desc: 't1' },
        { customerId: 1, name: 'ana' } ],
    ...
    it('all promise', async () => {
        const r0 =  await F.collect(
            F.innerJoin2(promiseJoinByCustomerId, promiseOrders, promiseCustomers)
        );
        assert.deepStrictEqual(r0, [ 
      [ { orderId: 1, customerId: 1, desc: 't1' },
        { customerId: 1, name: 'ana' } ],
