...
export function pipe<T0, R0, R1, R2, R3>(f0: (t0: T0) => (R0 | Promise<R0>), f1: (r0: R0) => (R1 | Promise<R1>), f2: (r1: R1) => (R2 | Promise<R2>), f3: (r2: R2) => (R3 | Promise<R3>)): (t0: T0) => Promise<R3>;
export function pipe<T0, T1, R0, R1, R2, R3>(f0: (t0: T0, t1: T1) => (R0 | Promise<R0>), f1: (r0: R0) => (R1 | Promise<R1>), f2: (r1: R1) => (R2 | Promise<R2>), f3: (r2: R2) => (R3 | Promise<R3>)): (t0: T0, t1: T1) => Promise<R3>;
export function pipe<T0, T1, T2, R0, R1, R2, R3>(f0: (t0: T0, t1: T1, t2: T2) => (R0 | Promise<R0>), f1: (r0: R0) => (R1 | Promise<R1>), f2: (r1: R1) => (R2 | Promise<R2>), f3: (r2: R2) => (R3 | Promise<R3>)): (t0: T0, t1: T1, t2: T2) => Promise<R3>;
export function pipe<T0, T1, T2, T3, R0, R1, R2, R3>(f0: (t0: T0, t1: T1, t2: T2, t3: T3) => (R0 | Promise<R0>), f1: (r0: R0) => (R1 | Promise<R1>), f2: (r1: R1) => (R2 | Promise<R2>), f3: (r2: R2) => (R3 | Promise<R3>)): (t0: T0, t1: T1, t2: T2, t3: T3) => Promise<R3>;
export function pipe<T0, T1, T2, T3, T4, R0, R1, R2, R3>(f0: (t0: T0, t1: T1, t2: T2, t3: T3, t4: T4) => (R0 | Promise<R0>), f1: (r0: R0) => (R1 | Promise<R1>), f2: (r1: R1) => (R2 | Promise<R2>), f3: (r2: R2) => (R3 | Promise<R3>)): (t0: T0, t1: T1, t2: T2, t3: T3, t4: T4) => Promise<R3>;
export function pipe<T0, T1, T2, T3, T4, T5, R0, R1, R2, R3>(f0: (t0: T0, t1: T1, t2: T2, t3: T3, t4: T4, t5: T5) => (R0 | Promise<R0>), f1: (r0: R0) => (R1 | Promise<R1>), f2: (r1: R1) => (R2 | Promise<R2>), f3: (r2: R2) => (R3 | Promise<R3>)): (t0: T0, t1: T1, t2: T2, t3: T3, t4: T4, t5: T5) => Promise<R3>;
...
export function pipe<T, R0, R1, R2, R3, R4, R5, R6>(f0: (t: T) => (R0 | Promise<R0>), f1: (r0: R0) => (R1 | Promise<R1>), f2: (r1: R1) => (R2 | Promise<R2>), f3: (r2: R2) => (R3 | Promise<R3>), f4: (r3: R3) => (R4 | Promise<R4>), f5: (r4: R4) => (R5 | Promise<R5>), f6: (r5: R5) => (R6 | Promise<R6>)): (t: T) => Promise<R6>;
export function pipe<T, R0, R1, R2, R3, R4, R5, R6, R7>(f0: (t: T) => (R0 | Promise<R0>), f1: (r0: R0) => (R1 | Promise<R1>), f2: (r1: R1) => (R2 | Promise<R2>), f3: (r2: R2) => (R3 | Promise<R3>), f4: (r3: R3) => (R4 | Promise<R4>), f5: (r4: R4) => (R5 | Promise<R5>), f6: (r5: R5) => (R6 | Promise<R6>), f7: (r6: R6) => (R7 | Promise<R7>)): (t: T) => Promise<R7>;
export function pipe<T, R0, R1, R2, R3, R4, R5, R6, R7, R8>(f0: (t: T) => (R0 | Promise<R0>), f1: (r0: R0) => (R1 | Promise<R1>), f2: (r1: R1) => (R2 | Promise<R2>), f3: (r2: R2) => (R3 | Promise<R3>), f4: (r3: R3) => (R4 | Promise<R4>), f5: (r4: R4) => (R5 | Promise<R5>), f6: (r5: R5) => (R6 | Promise<R6>), f7: (r6: R6) => (R7 | Promise<R7>), f8: (r7: R7) => (R8 | Promise<R8>)): (t: T) => Promise<R8>;
export function pipe<T, R0, R1, R2, R3, R4, R5, R6, R7, R8, R9>(f0: (t: T) => (R0 | Promise<R0>), f1: (r0: R0) => (R1 | Promise<R1>), f2: (r1: R1) => (R2 | Promise<R2>), f3: (r2: R2) => (R3 | Promise<R3>), f4: (r3: R3) => (R4 | Promise<R4>), f5: (r4: R4) => (R5 | Promise<R5>), f6: (r5: R5) => (R6 | Promise<R6>), f7: (r6: R6) => (R7 | Promise<R7>), f8: (r7: R7) => (R8 | Promise<R8>), f9: (r8: R8) => (R9 | Promise<R9>)): (t: T) => Promise<R9>;
export function pipe<T, R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10>(f0: (t: T) => (R0 | Promise<R0>), f1: (r0: R0) => (R1 | Promise<R1>), f2: (r1: R1) => (R2 | Promise<R2>), f3: (r2: R2) => (R3 | Promise<R3>), f4: (r3: R3) => (R4 | Promise<R4>), f5: (r4: R4) => (R5 | Promise<R5>), f6: (r5: R5) => (R6 | Promise<R6>), f7: (r6: R6) => (R7 | Promise<R7>), f8: (r7: R7) => (R8 | Promise<R8>), f9: (r8: R8) => (R9 | Promise<R9>), f10: (r9: R9) => (R10 | Promise<R10>)): (t: T) => Promise<R10>;
...
// export function pipe<T, F extends ((...args: any[]) => any)[]>(f0: (t: T) => any, ...f: F): (t: T) => Promise<LastReturnType<F>>;
