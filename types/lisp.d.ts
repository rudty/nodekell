 ...
 * No jsdoc
 */
/* export function condv<V, T extends PairRepeat<2, BFV<V>, any>>(v: V, ...a: T): Promise<EP<Filter<() => true, T> extends never ? PickElements<1, T> | undefined : PickElements<1, T>>>;
export function condv<V, T extends PairRepeat<4, BFV<V>, any>>(v: V, ...a: T): Promise<EP<Filter<() => true, T> extends never ? PickElements<1, T> | undefined : PickElements<1, T>>>;
export function condv<V, T extends PairRepeat<6, BFV<V>, any>>(v: V, ...a: T): Promise<EP<Filter<() => true, T> extends never ? PickElements<1, T> | undefined : PickElements<1, T>>>;
export function condv<V, T extends PairRepeat<8, BFV<V>, any>>(v: V, ...a: T): Promise<EP<Filter<() => true, T> extends never ? PickElements<1, T> | undefined : PickElements<1, T>>>;
export function condv<V, T extends PairRepeat<10, BFV<V>, any>>(v: V, ...a: T): Promise<EP<Filter<() => true, T> extends never ? PickElements<1, T> | undefined : PickElements<1, T>>>;
export function condv<V, T extends PairRepeat<12, BFV<V>, any>>(v: V, ...a: T): Promise<EP<Filter<() => true, T> extends never ? PickElements<1, T> | undefined : PickElements<1, T>>>;
export function condv<V, T extends PairRepeat<14, BFV<V>, any>>(v: V, ...a: T): Promise<EP<Filter<() => true, T> extends never ? PickElements<1, T> | undefined : PickElements<1, T>>>;
export function condv<V, T extends PairRepeat<16, BFV<V>, any>>(v: V, ...a: T): Promise<EP<Filter<() => true, T> extends never ? PickElements<1, T> | undefined : PickElements<1, T>>>;
export function condv<V, T extends PairRepeat<18, BFV<V>, any>>(v: V, ...a: T): Promise<EP<Filter<() => true, T> extends never ? PickElements<1, T> | undefined : PickElements<1, T>>>;
export function condv<V, T extends PairRepeat<20, BFV<V>, any>>(v: V, ...a: T): Promise<EP<Filter<() => true, T> extends never ? PickElements<1, T> | undefined : PickElements<1, T>>>;
 */
